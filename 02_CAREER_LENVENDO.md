## Проект "Магнит. Доставка", команда Collect Service (inner source)  
**GO разработчик**  
  
- Разработка модуля валидации марок.  
Интеграция с ГИС МТ. Приоритезация cdn. Конкурентный алгоритм. Обработка аварийного режима.  
  
- Трансфер бизнес логики с HTTP на Kafka рельсы.  
